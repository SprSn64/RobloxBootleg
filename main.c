...
int main(int argc, char *argv[]){
	...
	keyList[0].scanCode = GLFW_KEY_W; keyList[1].scanCode = GLFW_KEY_S;  
	keyList[2].scanCode = GLFW_KEY_A; keyList[3].scanCode = GLFW_KEY_D; 
	keyList[4].scanCode = GLFW_KEY_SPACE; keyList[5].scanCode = GLFW_KEY_LEFT_SHIFT;
	keyList[6].scanCode = GLFW_KEY_UP; keyList[7].scanCode = GLFW_KEY_DOWN;  
	keyList[8].scanCode = GLFW_KEY_LEFT; keyList[9].scanCode = GLFW_KEY_RIGHT; 
